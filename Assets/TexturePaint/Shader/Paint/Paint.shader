Shader "Es/TexturePaint/Paint"{
	Properties{
		...
		[HideInInspector]
		[KeywordEnum(USE_CONTROL, USE_BRUSH, NEUTRAL)]
...
#include "Assets/TexturePaint/Shader/Lib/TexturePaintFoundation.cginc"
		...
		Pass{
			CGPROGRAM
#pragma multi_compile TEXTURE_PAINT_COLOR_BLEND_USE_CONTROL TEXTURE_PAINT_COLOR_BLEND_USE_BRUSH TEXTURE_PAINT_COLOR_BLEND_NEUTRAL
#pragma vertex vert
